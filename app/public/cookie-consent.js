...
function CookieConsent(props) {
    ...
    this.props = {
        ...
        buttonSecondaryClass: "btn", // the "accept necessary" buttons class, only used for styling
        ...
        content: { // the content in all needed languages
            ...
            pl: {
                title: "Pliki cookies",
                body: "Używamy plików cookies aby zapewnić poprawne funkcjonowanie strony. ",
